                ...
                <CardContent className="p-4 sm:p-6 lg:p-12">
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
                    ...
                    <div className="lg:col-span-2 space-y-6 order-2 lg:order-1">
                      <Quote className="h-10 w-10 sm:h-12 sm:w-12 text-primary/20" />

                      <blockquote className="text-base sm:text-lg lg:text-xl leading-relaxed text-muted-foreground italic">
                        ...
                        apoio para acessar direitos — , mas sabíamos que era só
                        o começo.&rdquo;
                      </blockquote>
                    ...
                    <div className="flex justify-center order-1 lg:order-2">
                      <div className="relative w-40 sm:w-56 lg:w-[250px]">
                        <Image
                          src="/imageH.png"
                        ...
                        />
                        <div className="absolute -bottom-4 -right-4 w-16 h-16 sm:w-20 sm:h-20 bg-primary/10 rounded-full blur-2xl" />
                      </div>
                    </div>
                  </div>
                </CardContent>
